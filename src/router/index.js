...
export default new Router({
  routes: [
    ...
    { path: '/game/statics/:type/:text', name: 'statics', component: require('../views/game/statics'),meta: { requiresAuth: true }},
    { path: '/game/trend/:type/:text', name: 'trend', component: require('../views/game/trend'),meta: { requiresAuth: true }},
    { path: '/game/record/:type/:text', name: 'record', component: require('../views/game/record'),meta: { requiresAuth: true }},
    { path: '/game/helper/:type/:text', name: 'helper', component: require('../views/game/helper'),meta: { requiresAuth: true }},
    { path: '/game/model/:type/:text', name: 'model', component: require('../views/game/model'),meta: { requiresAuth: true }},    
